...
export default function SongOfTheDayCard({spotifyId, title, artist, albumImage}: SpotifyTrack) {
    return(
        <div className="w-120 p-8 border border-background-light rounded-xl bg-background flex flex-col items-center justify-center text-center">
            ...
            <div className="flex flex-col items-center">
                <img 
                    src={albumImage ? albumImage : "https://i0.wp.com/unleash-gods-dream.com/wp-content/uploads/2023/03/placeholder-image-blue-square.png?fit=500%2C500&ssl=1&w=640"}
                    alt={`Capa do álbum da música ${title}`}
                ...
                <div className="mt-4">
                    ...
                    <p className="text-text-muted text-sm mt-1">{artist}</p>
                </div>
            </div>
